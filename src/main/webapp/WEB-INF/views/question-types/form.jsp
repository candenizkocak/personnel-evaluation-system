...
<h2 class="mb-4">${isEdit ? 'Edit' : 'Add New'} Question Type</h2>
...
<c:if test="${not empty org.springframework.validation.BindingResult.questionType}">
    <div class="alert alert-danger">
        <ul>
            <c:forEach var="error" items="${org.springframework.validation.BindingResult.questionType.allErrors}">
