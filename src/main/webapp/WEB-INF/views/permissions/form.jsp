...
<h2 class="mb-4">${isEdit ? 'Edit' : 'Add New'} Permission</h2>
...
<c:if test="${not empty org.springframework.validation.BindingResult.permission}">
    <div class="alert alert-danger">
        <ul>
            <c:forEach var="error" items="${org.springframework.validation.BindingResult.permission.allErrors}">
